# USAGE
# python train_mobilenetv2_object_detection.py
# import the necessary packages
from utils.mobilenetv2_bbox_regressor import ObjectDetector
...
print("len of trainDS: ", len(trainDS))
...
# device
objectDetector = ObjectDetector(net, len(le.classes_))
